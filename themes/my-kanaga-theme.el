...
(custom-theme-set-faces
 'my-kanaga
 '(default ((t (:inherit nil :extend nil :stipple nil :background "black" :foreground "#DCD7BA" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight regular :height 124 :width normal :foundry "1ASC" :family "Droid Sans Mono"))))
